  ...
  <>
    ...
    >
      <path
        ...
        stroke={white ? "white" : "url(#btn-left)"} // Defined in ButtonGradient.jsx
        strokeWidth="2"
    ...
    >
      {white ? (
        ...
        <>
          <polygon
            fill="url(#btn-top)" // Defined in ButtonGradient.jsx
            fillRule="nonzero"
            points="100 42 100 44 0 44 0 42"
          />
          <polygon
            fill="url(#btn-bottom)" // Defined in ButtonGradient.jsx
            fillRule="nonzero"
    ...
    >
      <path
        fill={white ? "white" : "none"}
        stroke={white ? "white" : "url(#btn-right)"} // Defined in ButtonGradient.jsx
        strokeWidth="2"
